...
public class ConstantValues {
    ...
    public static final String FAST_FORWARD_BUTTON_IMAGE_FILE2 = "fast-forward-button-2";
    public static final String BACK_FORWARD_BUTTON_IMAGE_FILE = "back-forward-button-1";
    public static final String BACK_FORWARD_BUTTON_IMAGE_FILE2 = "back-forward-button-2";
